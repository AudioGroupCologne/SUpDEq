%% (8) - Plot and compare Reference HRTF's with CTA-HRTF's, MCA-HRFT's, ILD-HRTF's
%Use this script, to generate the datasets by supdey_demo_MCA_HUTUBS.m
clear all;
...
%Load data
HRTF_Dataset = load([fullfile('mat_data','HUTUBS_interp_N'), num2str(Ns), '.mat']);
