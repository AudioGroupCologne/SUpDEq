...
%     
%
%   Url: http://amtoolbox.org/amt-1.4.0/doc/modelstages/baumgartner2014_pmv2ppp.php
...
if flags.do_print
  ...
  elseif flags.do_QE 
    amt_disp(sprintf('Local polar RMS error (deg) \t %4.1f',pe),'documentation');
  elseif flags.do_EB
    amt_disp(sprintf('Local elevation bias (deg) \t\t %4.1f',eb),'documentation');
  elseif flags.do_absPE
    amt_disp(sprintf('Absolute polar error (deg) \t\t %4.1f',ape),'documentation');
  end
end
