function CBH = cbhandle(varargin)
    ...
    if verLessThan('matlab', '8.4')
        CBH = cbhandle2014a_orLess(varargin);
    else
        CBH = cbhandle2014b_orHigher(varargin);
    end
...
function CBH = cbhandle2014a_orLess(varargin)
...
function CBH = cbhandle2014b_orHigher(varargin)
...
end % [EOF] CBHANDLE.M by Carlos A. Vargas A.