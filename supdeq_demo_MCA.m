...
N = 44; % either 35 or 44 (ku100-dataset)
...
%% (8) - Get Reference data

%Get reference data
%Sparse KU100 HRTF set based on "HRIR_L2702.sofa" dataset in SH domain
...
%% (9) Save Dataset in .mat file for further processing/calculations
...
save([fullfile('mat_data','ku100_interp_N'),num2str(Ns),'.mat'],'ref_HRTF','interpHRTF_mca','interpHRTF_con','interpHRTF_ild')

%% (10) - Plot and compare Reference HRTF's with CTA-HRTF's, MCA-HRFT's, ILD-HRTF'S
%Also use the script plots/plot_HRTFs_ku100.m to plot the HRTFs with
