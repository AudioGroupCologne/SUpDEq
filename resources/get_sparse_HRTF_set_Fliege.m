...
%
% script get_sparse_HRTF_set_Fliege
%
...
[sparseGrid, ~, NmaxSparse] = supdeq_fliege(4);
...
% Save as mat file
fileName = ['sparseHRTFdataset_F',num2str(nSparse)];
...
% Save as SOFA file
fileName = ['sparseHRIRdataset_F',num2str(nSparse),'.sofa'];
